...
const data = [
  {
    id: 1,
    image: '/imagesN/cleaning-section10th-1.jpg',
  ...
  {
    id: 2,
    image: '/imagesN/cleaning-section10th-2.jpg',
    subTitle: '여름철 사무실 환경 관리',
    mainTitle: '해충 방제',
  ...
  {
    id: 3,
    image: '/imagesN/cleaning-section10th-3.jpg',
      ...
      <ul className='cleaningSection10th_b-body'>
        {data.map((item, index) => (
          <li key={index} className='fade-up-element'>
            <Image className='card-image' src={item.image} alt="card image" width={400} height={240} />
